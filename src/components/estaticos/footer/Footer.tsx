          ...
          <Grid container direction="row" justifyContent="center" alignItems="center">
                <Grid alignItems="center" item xs={12}>
                    ...
                    <Box style={{ backgroundColor: "#000000", height: "60px" }}>
                        <Box paddingTop={1}>
                            <Typography variant="subtitle2" align="center" gutterBottom style={{ color: "white" }} >© 2023 Guilherme Henrique</Typography>
                        </Box>
                        <Box>
                            <a target="_blank" href="https://www.linkedin.com/in/guilhermehenrique-lima/">
                                <Typography variant="subtitle2" gutterBottom style={{ color: "white" }} align="center">@guilhermehenrique</Typography>
                            </a>
                        </Box>
                    </Box>
                </Grid>
